...
class HackController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Hack::create([
            'namehack' => $request->namehack,
            'group' => $request->group,
            'numberHack' => $request->numberHack,
            'obs' => $request->obs,
        ]);

        return redirect()->route('admin.hacks.create.index')->with('create', 1);
    }
    ...
    public function destroy($id)
    {
        ...
        return  redirect()->route('admin.hacks.list.index')->with('destroy', '1');
    }
}
