    ...
    <div class="card mb-2">
        <div class="card-body">
            <h2 class="h5 page-title"><b>
                    <a href="{{ url('admin/cliente/list') }}">Listar Cliente</a>
        ...
        <div class="card-body">
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-md-3">
                        <p class="text-dark">
                            <b>Cliente/Empresa </b><br>
                            <small> {{ $customers->name }}</small>
                        </p>
                    </div>
                    <div class="col-md-3">
                        <p class="text-dark">
                            <b>Teleone do Cliente/Empresa </b><br>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-dark text-right">
                        <a type="button" class="btn btn-primary text-left text-white mb-2 btn-fw"
                            href='{{ url("admin/cliente/edit/{$customers->id}") }}'>
