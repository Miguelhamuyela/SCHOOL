                        ...
                        <div class="col-lg-3 col-md-6 mt-md-0 mt-4">
                            <div class="d-flex">
                                <div class="wrapper">
                                    ...
                                    <a class="mb-0 font-weight-medium text-primary h5" href="{{ route('admin.veeam_backups.list.index') }}">Máquinas de backup</a>
                        ...
                        <div class="col-lg-3 col-md-6 mt-md-0 mt-4">
                            <div class="d-flex">
                                <div class="wrapper">
                                    ...
                                    <a class="mb-0 font-weight-medium text-primary h5" href="{{ route('admin.virtual_machines.index') }}">Máquina Virtual</a>
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body pb-0">
                            <div class="d-flex justify-content-between">
                                <a class="mb-0 font-weight-medium text-primary h5" href="{{ route('admin.physical_machines.list.index') }}">Maquina Física</a>
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body pb-0">
                            <div class="d-flex justify-content-between">
                                <a class="mb-0 font-weight-medium text-primary h5" href="{{ route('admin.requests.index') }}">Total de Solicitação <br>de Serviço</a>
                                <p class="font-weight-semibold mb-0">{{ $requests/100 }}%</p>
                            </div>
                            <h3 class="font-weight-medium mb-4">{{ $requests }}</h3>
                        </div>
