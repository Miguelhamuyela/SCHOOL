...
<body style='height:auto; width:100%; background: url("dashboard/images/digital.canvas.pnghh") no-repeat center;'>
    <header>
        <img src="dashboard/images/favicon.png" alt="logo noc" width="200">
        <br>
        <b>Data:</b> {{ date('d-m-Y') }}
        <br>
