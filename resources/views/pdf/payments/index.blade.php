...
<body style='height:auto; width:100%; background: url("dashboard/images/digital.canvas.pngGG") no-repeat center;'>


        <img src="dashboard/images/logo_blue.png" alt="logo noc" width="200">
