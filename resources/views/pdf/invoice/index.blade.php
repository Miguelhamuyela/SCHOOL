...
<body style='height:auto; width:100%; background: url("dashboard/images/favicon.png") no-repeat center;'>

    <header class="col-12 mt-2 row mb-5">

                <div class="col-12">
                    <img src="dashboard/images/favicon.png" alt="logo NOC" width="150" class="mt-3">
